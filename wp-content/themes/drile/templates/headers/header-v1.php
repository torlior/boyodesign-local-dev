	...
	<div class="header-container">
		<div class="header-template">
			...
			<?php if( $drile_theme_options['ts_header_contact_information'] || $drile_theme_options['ts_header_currency'] || $drile_theme_options['ts_header_language'] || ( function_exists('ts_header_social_icons') && $drile_theme_options['ts_enable_header_social_icons'] ) ): ?>
				...
				<div class="header-top hidden-ipad <?php echo esc_attr($header_top_classes); ?>">
					<div class="container">
						...
						<div class="header-right">
							...
							<div class="header-currency"><?php drile_woocommerce_multilingual_currency_switcher(); ?></div>
							<?php endif; ?>
							
							<?php if( $drile_theme_options['ts_header_language'] ): ?>
							<div class="header-language"><?php drile_wpml_language_selector(); ?></div>
							<?php endif; ?>
			...
			<div class="header-middle header-sticky">
				<div class="container">
					...
					<div class="menu-wrapper hidden-ipad">
						...
						<?php if( $drile_theme_options['ts_enable_search'] && $drile_theme_options['ts_search_style'] == 'search-default' ): ?>
