				...
				<div class="container">
					...
					<div class="header-meta-wrapper">
						<div class="menu-wrapper hidden-ipad">
							...
							<div class="header-language hidden-ipad"><?php drile_wpml_language_selector(); ?></div>
							<?php endif; ?>
							
							<?php if( $drile_theme_options['ts_header_currency'] ): ?>
							<div class="header-currency hidden-ipad"><?php drile_woocommerce_multilingual_currency_switcher(); ?></div>
							<?php endif; ?>
