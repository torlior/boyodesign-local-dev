...
class TS_Custom_Product_Category{
	...
	function add_category_fields(){
		$default_sidebars = function_exists('drile_get_list_sidebars')?drile_get_list_sidebars():array();
		...
		<div class="form-field ts-product-cat-upload-field">
			<label><?php esc_html_e( 'Icon (Used for shortcode)', 'themesky' ); ?></label>
	...
	function edit_category_fields( $term, $taxonomy ){
		...
		<tr class="form-field ts-product-cat-upload-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Icon (Used for shortcode)', 'themesky' ); ?></label></th>
			<td>
				<div class="preview-image">
					<?php 
					if( empty($icon_id) ){
